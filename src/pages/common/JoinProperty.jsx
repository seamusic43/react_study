...
export const JoinProperty = [
    ...
    { 'name': 'email', 'type': 'email', 'placeholder': 'enter the email', required: true, pattern: '/^([\\.w-]+(?:\\.[\\.w-]+)*)@((?:[\\.w-]+\\.)*\\.w[\\.w-]{0,66})\\.([a-z]{2,6}(?:\\.[a-z]{2})?)$/i' },
    ...
    { 'name': 'business_number', 'type': 'text', 'placeholder': 'enter the business number', required: true, pattern: '/^([0-9]{3})-([0-9]{2})-([0-9]{5})$/i', minlength: 12, maxlength: 12 },
